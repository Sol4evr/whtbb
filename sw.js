const SHELL_CACHE = "whtbb-shell-v15";
const GAME_CACHE = "whtbb-game-v15";
const SHELL = ["/", "/index.html", "/manifest.json", "/stable-v15.js", "/icons/icon-180.png", "/icons/icon-192.png", "/icons/icon-512.png"];
