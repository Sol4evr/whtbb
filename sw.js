const SHELL_CACHE = "whtbb-shell-v15.1";
const GAME_CACHE = "whtbb-game-v15.1";
const SHELL = ["/", "/index.html", "/manifest.json", "/stable-v15.js?v=15.1.0", "/icons/icon-180.png", "/icons/icon-192.png", "/icons/icon-512.png"];
